             ...
             <ul class="list">
                     ...
                     <ul class="ml-menu">
                         <li>
                             ...
                             <ul class="ml-menu">
                                 ...
                                 <li>
                                     <a href="<?= base_url(); ?>assets/pages/widgets/cards/no-header.html">No Header</a>
                                 </li>
                             </ul>
                         </li>
                         <li>
                             ...
                             <ul class="ml-menu">
                                 <li>
                                     <a href="<?= base_url(); ?>assets/pages/widgets/infobox/infobox-1.html">Infobox-1</a>
                                 </li>
                                 <li>
                                     <a href="<?= base_url(); ?>assets/pages/widgets/infobox/infobox-2.html">Infobox-2</a>
                                 </li>
                                 <li>
                                     <a href="<?= base_url(); ?>assets/pages/widgets/infobox/infobox-3.html">Infobox-3</a>
                                 </li>
                                 <li>
                                     <a href="<?= base_url(); ?>assets/pages/widgets/infobox/infobox-4.html">Infobox-4</a>
                                 </li>
                                 <li>
                                     <a href="<?= base_url(); ?>assets/pages/widgets/infobox/infobox-5.html">Infobox-5</a>
                                 </li>
                             </ul>
                         </li>
                     </ul>
                 ...
                 <li>
                     ...
                     <ul class="ml-menu">
                         ...
                         <li>
                             <a href="<?= base_url(); ?>assets/pages/ui/sortable-nestable.html">Sortable & Nestable</a>
                         </li>
                         <li>
                         ...
                         <li>
                             <a href="<?= base_url(); ?>assets/pages/ui/tooltips-popovers.html">Tooltips & Popovers</a>
                         </li>
                         <li>
                 ...
                 <li>
                     ...
                     <ul class="ml-menu">
                         <li>
                             <a href="<?= base_url(); ?>assets/pages/forms/basic-form-elements.html">Basic Form Elements</a>
                         </li>
                         <li>
                             <a href="<?= base_url(); ?>assets/pages/forms/advanced-form-elements.html">Advanced Form Elements</a>
                         </li>
                         <li>
                 ...
                 <li>
                     ...
                     <ul class="ml-menu">
                         ...
                         <li>
                             <a href="<?= base_url(); ?>assets/pages/examples/forgot-password.html">Forgot Password</a>
                         </li>
                         <li>
