                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" id="nosm" class="form-control" placeholder="Masukan nomor surat" name="nosm" value="<?= set_value('nosm'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" id="judulsm" class="form-control" placeholder="Masukan judul surat" name="judulsm" value="<?= set_value('judulsm'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" id="asalsm" class="form-control" placeholder="Masukan asal surat" name="asalsm" value="<?= set_value('asalsm'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="date" name="tglmasuksm" id="tglmasuksm" value="<?= set_value('tglmasuksm'); ?>">
                            ...
                            <div class="col-4">
                                <div class="form-group row">
                                    <div class="col-lg col-md col-xs">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <input type="file" name="suratfile" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
